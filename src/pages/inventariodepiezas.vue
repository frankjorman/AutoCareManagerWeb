...
export default {
  ...
  methods: {
    ...
    updateEmployee() {
      axios
        .put("http://localhost:5116/api/InventarioPiezas", this.form)
        .then((response) => {
          this.getEmployees();
        })
        .finally(() => {
    ...
    registerEmployee() {
      ...
      axios
        .post("http://localhost:5116/api/InventarioPiezas", this.form)
        .then((response) => {
          this.getEmployees();
        })
        .finally(() => {
    ...
    getEmployees() {
      axios
        .get("http://localhost:5116/api/InventarioPiezas")
        .then((response) => {
          this.InventarioPiezas = response.data;
        })
        .finally(() => {
          this.loading = false;
        });
    ...
    deleteEmploye(idEmpleado) {
      axios
        .delete(http://localhost:5116/api/InventarioPiezas/${idEmpleado})
        .then(() => {
          this.getEmployees();
